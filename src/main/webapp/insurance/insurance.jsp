...
<div id="wrap">
	<div id="form_1">
		<div id="form_2">
			<h2>렌트카 보험 안내</h2>
			<hr>
			<img alt="자차 보험 안내 이미지" src="../images/insurance.PNG">
			<div id="ins_txt">
				<ol>
				...
				<p id="ptxt">&#8251; 다음의 경우는 보험처리 및 차량손해(자차) 면책처리가 불가능합니다.</p>
				<div id="bul1">
					<ol>
						...
						<li>1사고 1건 초과 사고</li>
						<li>타이어펑크 및 타이어파손 비용, 사고 후 견인, 현장출동(배터리방전, 키분실 등)비용은 자차에 적용되지 않습니다. (고객부담)</li>				
					</ol>
				</div><!-- bul1 end-->
				<p id="ptxt">&#8251; 12대 중과실 항목 위반시에도 면책처리 불가능합니다.</p>
				<div id="bul2">
					<ol>
						<li>신호 및 지시 위반</li>
						<li>중앙선침범, 불법유턴</li>
